'''
Active boundary loss for semantic segmentation (AAAI 2022)
https://ojs.aaai.org/index.php/AAAI/article/view/20139
Code from: https://github.com/wangchi95/active-boundary-loss/
'''
...
class ABL(nn.Module):
    def __init__(self, device, isdetach=True, max_N_ratio = 1/100, ignore_label = 255, label_smoothing=0.2, weight = None, max_clip_dist = 20.):
